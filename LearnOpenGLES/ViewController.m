...
- (void)loadAsset {
    ...
    AVURLAsset *inputAsset = [[AVURLAsset alloc] initWithURL:[[NSBundle mainBundle] URLForResource:@"5" withExtension:@"mp4"] options:inputOptions];
